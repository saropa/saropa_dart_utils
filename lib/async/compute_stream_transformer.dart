...
/// );
/// ```
class ComputeStreamTransformer<TInput, TOutput> extends StreamTransformerBase<TInput, TOutput> {
  ...
  @override
  Stream<TOutput> bind(Stream<TInput> stream) => stream.asyncMap((TInput data) async {
    try {
