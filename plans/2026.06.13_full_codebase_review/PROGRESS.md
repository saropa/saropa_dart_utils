...
- ➡️ 1e Unicode — folded into Phase 2.4 (string) deep read
- ➡️ 1f numeric edges — folded into Phase 2.3/2.8 (stats, num/int/double)
- ➡️ 1g boundaries — folded into Phase 2.5 (datetime) deep read
