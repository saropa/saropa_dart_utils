...
void main() {
  group('isNthDayOfMonthInRange', () {
    test('returns true for 2nd Monday of March within range', () {
      final range = DateTimeRange(start: DateTime(2023), end: DateTime(2023, 12, 31));
      expect(range.isNthDayOfMonthInRange(2, DateTime.monday, 3), true);
    });

    test('returns false for 2nd Monday of March outside range', () {
      final range = DateTimeRange(start: DateTime(2023, 4), end: DateTime(2023, 12, 31));
    ...
    test('returns false for day just after range', () {
      final range = DateTimeRange(start: DateTime(2023), end: DateTime(2023, 12, 30));
    ...
    test('returns true for recurring holiday across multiple years', () {
      final range = DateTimeRange(start: DateTime(2022), end: DateTime(2024, 12, 31));
    ...
    test('returns true for leap year day when in range', () {
      final range = DateTimeRange(start: DateTime(2024), end: DateTime(2024, 12, 31));
    ...
    test('returns true for 1st Monday of January in multi-year range', () {
      final range = DateTimeRange(start: DateTime(2023), end: DateTime(2025, 12, 31));
    ...
    test('returns false for 4th Thursday of November (Thanksgiving) in range '
      ...
      final range = DateTimeRange(start: DateTime(2023), end: DateTime(2023, 10, 31));
  ...
  group('DateTimeCheck extension', () {
    group('inRange', () {
      test('returns true when date is within range', () {
        final range = DateTimeRange(start: DateTime(2025), end: DateTime(2025, 1, 31));
    ...
    group('isNowInRange', () {
      ...
      test('returns false when current date is equal to end', () {
        final now = DateTime.now();
        final range = DateTimeRange(start: now.subtract(const Duration(days: 1)), end: now);
        expect(range.isNowInRange(now: now), isFalse);
      });
