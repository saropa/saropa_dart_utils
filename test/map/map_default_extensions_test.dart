...
void main() {
  group('MapDefaultExtensions', () {
    test('returns the default for a missing key', () {
      final MapDefaultExtensions<String, int> m = MapDefaultExtensions<String, int>(<String, int>{
        'a': 1,
      }, 0);
      expect(m['a'], 1);
      expect(m['missing'], 0);
    ...
    test('addEntries writes through to the wrapped map', () {
      final MapDefaultExtensions<String, int> m = MapDefaultExtensions<String, int>(
        <String, int>{},
        0,
      );
