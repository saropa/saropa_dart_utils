...
void main() {
  group('diff', () {
    test('reports added, removed, and unchanged', () {
      ...
      final (List<int> added, List<int> removed, List<int> unchanged) result =
          <int>[1, 2, 3].diff(<int>[2, 3, 4]);
