  ...
  group('ListIntExtensions', () {
    test('mostOccurrences', () {
      ...
      expect(
        ...
        anyOf(equals(Occurrence<int>(1, 1)), equals(Occurrence<int>(2, 1)), equals(Occurrence<int>(3, 1)), equals(Occurrence<int>(4, 1)), equals(Occurrence<int>(5, 1))),
      );
    ...
    test('leastOccurrences', () {
      expect(
        ...
        anyOf(equals(Occurrence<int>(3, 1)), equals(Occurrence<int>(4, 1)), equals(Occurrence<int>(5, 1)), equals(Occurrence<int>(9, 1))),
      );
      expect(<int>[10, 20, 10, 30, 10].leastOccurrences(), anyOf(equals(Occurrence<int>(20, 1)), equals(Occurrence<int>(30, 1))));
