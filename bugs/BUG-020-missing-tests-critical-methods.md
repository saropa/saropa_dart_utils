...
**Partial fix note (2026-03-06):** Some tests were added (MapNullableExtensions, GestureUtils, obscureText, hasInvalidUnicode/removeInvalidUnicode). Other methods in this report may still have zero or insufficient coverage; re-run coverage and this doc to confirm remaining gaps.
